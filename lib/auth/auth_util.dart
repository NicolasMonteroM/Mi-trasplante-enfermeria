...
DocumentReference get currentUserReference => currentUser?.user != null
    ? UsersEnfermeriaRecord.collection.doc(currentUser.user.uid)
    : null;

UsersEnfermeriaRecord currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : UsersEnfermeriaRecord.getDocument(
                  UsersEnfermeriaRecord.collection.doc(uid))
              .handleError((_) {}),
    )
