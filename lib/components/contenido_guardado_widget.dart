...
class ContenidoGuardadoWidget extends StatefulWidget {
  const ContenidoGuardadoWidget({
    Key key,
    this.preview,
    this.nombre,
  ...
  @override
  _ContenidoGuardadoWidgetState createState() =>
      _ContenidoGuardadoWidgetState();
}

class _ContenidoGuardadoWidgetState extends State<ContenidoGuardadoWidget> {
  @override
