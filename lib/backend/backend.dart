...
Stream<List<ContenidosRecord>> queryContenidosRecord(
    ...
    queryCollection(ContenidosRecord.collection, ContenidosRecord.serializer,
...
Future<List<ContenidosRecord>> queryContenidosRecordOnce(
        ...
        bool singleRecord = false}) =>
    queryCollectionOnce(
        ContenidosRecord.collection, ContenidosRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);
...
Stream<List<UsersEnfermeriaRecord>> queryUsersEnfermeriaRecord(
        ...
        bool singleRecord = false}) =>
    queryCollection(
        UsersEnfermeriaRecord.collection, UsersEnfermeriaRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);
