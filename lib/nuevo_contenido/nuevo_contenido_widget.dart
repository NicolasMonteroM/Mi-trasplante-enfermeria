                                    ...
                                    onPressed: () async {
                                      ...
                                      final contenidosCreateData = {
                                        ...createContenidosRecordData(
                                          ...
                                          previewImage: uploadedFileUrl1,
                                          categoriaPrincipal:
                                              categoriasContenidosValue,
                                          imgMicro1:
                                              functions.seleccionImagenMicro(
                                                  uploadedFileUrl2,
                                                  uploadedFileUrl3),
                                          tipoImgMicro1: imagenTipoValue1,
                                          nombreMicro1:
                                              claveMicro1Controller.text,
                                          infoMicro1: infoMicro1Controller.text,
                                          imgMicro2:
                                              functions.seleccionImagenMicro(
                                                  uploadedFileUrl4,
                                                  uploadedFileUrl5),
                                          tipoImgMicro2: imagenTipoValue2,
                                          nombreMicro2:
                                              claveMicro2Controller.text,
                                          infoMicro2: infoMicro2Controller.text,
                                          imgMicro3:
                                              functions.seleccionImagenMicro(
                                                  uploadedFileUrl6,
                                                  uploadedFileUrl7),
                                          tipoImgMicro3: imagenTipoValue3,
                                          nombreMicro3:
                                              claveMicro3Controller.text,
                                          infoMicro3: infoMicro3Controller.text,
                                          imgMicro4:
                                              functions.seleccionImagenMicro(
                                                  uploadedFileUrl8,
                                                  uploadedFileUrl9),
                                          tipoImgMicro4: imagenTipoValue4,
                                          nombreMicro4:
                                              claveMicro4Controller.text,
                                          infoMicro4: infoMicro4Controller.text,
                                          imgMicro5:
                                              functions.seleccionImagenMicro(
                                                  uploadedFileUrl10,
                                                  uploadedFileUrl11),
                                          tipoImgMicro5: imagenTipoValue5,
                                          nombreMicro5:
                                              claveMicro5Controller.text,
                                          infoMicro5: infoMicro5Controller.text,
                                        ),
                                        'categorias_secundarias':
                                            categoriasSecundariasValues,
                                        'etapas_relevantes': etapasValues,
                                      };
