                                                                ...
                                                                Expanded(
                                                                  child: StreamBuilder<
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      final wrapCategoriasRecord = wrapCategoriasRecordList
                                                                              .isNotEmpty
                                                                          ? wrapCategoriasRecordList
                                                                              .first
                                                                          : null;
                                                                        ...
                                                                        children: [
                                                                          FlutterFlowChoiceChips(
                                                                            initiallySelected: choiceChipsValues1 != null
                                                                                ...
                                                                                : [],
                                                                            options:
                                                                                (wrapCategoriasRecord.listado.toList() ?? []).map((label) => ChipData(label)).toList(),
                                                                            onChanged: (val) =>
                                                        ...
                                                        children: [
                                                          ...
                                                          Row(
                                                            ...
                                                            children: [
                                                              Expanded(
                                                                child: Text(
                                                                  'Seleccione las etapas del trasplante en las que esste contenido es relevante',
                                                                  style: FlutterFlowTheme.of(
                                                                          context)
                                                                      .bodyText1,
                                                                ),
                                                                ...
                                                                Expanded(
                                                                  child: StreamBuilder<
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      final wrapEtapasTrasplanteRecord = wrapEtapasTrasplanteRecordList
                                                                              .isNotEmpty
                                                                          ? wrapEtapasTrasplanteRecordList
                                                                              .first
                                                                          : null;
                                                                        ...
                                                                        children: [
                                                                          FlutterFlowChoiceChips(
                                                                            initiallySelected: choiceChipsValues2 != null
                                                                                ...
                                                                                : [],
                                                                            options:
                                                                                (wrapEtapasTrasplanteRecord.listado.toList() ?? []).map((label) => ChipData(label)).toList(),
                                                                            onChanged: (val) =>
